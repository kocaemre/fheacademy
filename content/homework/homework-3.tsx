        ...
        <div className="rounded-lg border border-border bg-card p-5">
          <ul className="space-y-2 text-text-secondary">
            <li className="flex items-start gap-2.5">
              ...
              <span className="leading-relaxed">
                Create a GitHub repository with both the contract and frontend
                code
              </span>
            </li>
            <li className="flex items-start gap-2.5">
            ...
            <li className="flex items-start gap-2.5">
              ...
              <span className="leading-relaxed">
                ...
                ) with at least 3 test scenarios
              </span>
            </li>
            <li className="flex items-start gap-2.5">
              <span className="mt-0.5 flex size-5 shrink-0 items-center justify-center rounded-full bg-primary/10 text-xs font-medium text-primary">
              ...
              <span className="leading-relaxed">
                Include the React frontend in a{" "}
                <code className="rounded bg-code-bg px-1 py-0.5 text-sm font-mono text-primary">
                  frontend/
                </code>{" "}
                directory
            ...
            <li className="flex items-start gap-2.5">
              ...
              <span className="leading-relaxed">
                Include a README with architecture overview, setup instructions,
                and FHEVM features used
              </span>
            </li>
            <li className="flex items-start gap-2.5">
              <span className="mt-0.5 flex size-5 shrink-0 items-center justify-center rounded-full bg-primary/10 text-xs font-medium text-primary">
